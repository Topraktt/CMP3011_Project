...
from dataset_ssd import FaceMaskDataset
from ssd_model import SSDLite
...
def train_ssd(num_epochs=80, batch_size=16, learning_rate=0.001):
    ...
    train_dataset = FaceMaskDataset('face-mask-detection/train')
    val_dataset = FaceMaskDataset('face-mask-detection/val')
